  ...
  implements TypeAdapterFactory
{
  ...
  private final class Adapter extends TypeAdapter
  {
    ...
    public Adapter(Gson paramType1, Type paramTypeAdapter1, TypeAdapter paramType2, Type paramTypeAdapter2, TypeAdapter paramObjectConstructor, ObjectConstructor arg7)
    {
      this.keyTypeAdapter = new TypeAdapterRuntimeTypeWrapper(paramType1, paramType2, paramTypeAdapter1);
      this.valueTypeAdapter = new TypeAdapterRuntimeTypeWrapper(paramType1, paramObjectConstructor, paramTypeAdapter2);
      Object localObject;
