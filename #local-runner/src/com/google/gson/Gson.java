...
public final class Gson
{
    ...
    throws JsonIOException, JsonSyntaxException
  {
    ...
    try
    {
      ...
      i = 0;
      TypeAdapter localTypeAdapter = getAdapter(TypeToken.get(paramType));
      localObject1 = localTypeAdapter.read(paramJsonReader);
      return localObject1;
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder("{").append("serializeNulls:").append(this.serializeNulls).append("factories:").append(this.factories).append(",instanceCreators:").append(this.constructorConstructor).append("}");
