...
public final class Predicates
{
  ...
  public static Predicate and(Predicate[] paramArrayOfPredicate)
  {
  ...
  public static Predicate or(Predicate[] paramArrayOfPredicate)
  {
  ...
  private static List defensiveCopy(Object[] paramArrayOfObject)
  {
    return defensiveCopy(Arrays.asList(paramArrayOfObject));
  }
    ...
    implements Predicate, Serializable
  {
    ...
    {
      this.p = ((Serializable)Preconditions.checkNotNull(paramPredicate));
    ...
    implements Predicate, Serializable
  {
    ...
    public boolean apply(Object paramObject)
    {
      for (int i = 0; i < this.components.size(); i++)
        if (((Serializable)this.components.get(i)).apply(paramObject))
          return true;
      return false;
    }
    ...
    implements Predicate, Serializable
  {
    ...
    {
      this.predicate = ((Serializable)Preconditions.checkNotNull(paramPredicate));
    }
