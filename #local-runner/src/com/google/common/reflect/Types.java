...
final class Types
{
  ...
  static ParameterizedType newParameterizedTypeWithOwner(Type paramType, Class paramClass, Type[] paramArrayOfType)
  {
    if (paramType == null)
  ...
  static TypeVariable newTypeVariable(GenericDeclaration paramGenericDeclaration, String paramString, Type[] paramArrayOfType)
  {
    return new TypeVariableImpl(paramGenericDeclaration, paramString, paramArrayOfType.length == 0 ? new Type[] { Object.class } : paramArrayOfType);
  }
  ...
  static IllegalArgumentException buildUnexpectedTypeException(Type paramType, Class[] paramArrayOfClass)
  {
    ...
    localStringBuilder.append("but got: ").append(paramType.getClass().getName()).append(", for type: ").append(toString(paramType)).append('.');
  ...
  static abstract enum JavaVersion
  {
    ...
    static final JavaVersion CURRENT = (new TypeCapture()
    {
    }
  ...
  private static abstract enum ClassOwnership
  {
    ...
    {
      Class localClass = new 1LocalClass()
      {
      }
      $getClass();
