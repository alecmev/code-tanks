  ...
  implements Serializable
{
  ...
  {
    return this.forwardOrder.max(paramObject1, paramObject2, paramObject3, paramArrayOfObject);
  }
  ...
  {
    return this.forwardOrder.min(paramObject1, paramObject2, paramObject3, paramArrayOfObject);
  }
