...
public class TreeBasedTable extends StandardRowSortedTable
{
    ...
    implements SortedMap
  {
    ...
    TreeRow(Object paramObject1, Object paramObject2, Object arg4)
    {
      super(paramObject1);
      this.lowerBound = paramObject2;
      Object localObject;
      this.upperBound = localObject;
      Preconditions.checkArgument((paramObject2 == null) || (localObject == null) || (compare(paramObject2, localObject) <= 0));
    }
