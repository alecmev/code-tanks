  ...
  implements Serializable, ConcurrentMap
{
  ...
  ReferenceEntry getLiveEntry(Object paramObject)
  {
    if (paramObject == null)
      return null;
    int i = hash(paramObject);
  ...
  static class Segment extends ReentrantLock
  {
    ...
    boolean isCollected(MapMakerInternalMap.ReferenceEntry paramReferenceEntry)
    {
      if (paramReferenceEntry.getKey() == null)
        return true;
  ...
  static final class WeakExpirableEvictableEntry extends MapMakerInternalMap.WeakEntry
  ...
  static final class WeakEvictableEntry extends MapMakerInternalMap.WeakEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    MapMakerInternalMap.ReferenceEntry nextEvictable = MapMakerInternalMap.nullEntry();
    MapMakerInternalMap.ReferenceEntry previousEvictable = MapMakerInternalMap.nullEntry();
  ...
  static final class WeakExpirableEntry extends MapMakerInternalMap.WeakEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    volatile long time = 9223372036854775807L;
    MapMakerInternalMap.ReferenceEntry nextExpirable = MapMakerInternalMap.nullEntry();
  ...
  static final class SoftExpirableEvictableEntry extends MapMakerInternalMap.SoftEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    volatile long time = 9223372036854775807L;
    MapMakerInternalMap.ReferenceEntry nextExpirable = MapMakerInternalMap.nullEntry();
  ...
  static final class SoftEvictableEntry extends MapMakerInternalMap.SoftEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    MapMakerInternalMap.ReferenceEntry nextEvictable = MapMakerInternalMap.nullEntry();
    MapMakerInternalMap.ReferenceEntry previousEvictable = MapMakerInternalMap.nullEntry();
  ...
  static final class SoftExpirableEntry extends MapMakerInternalMap.SoftEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    volatile long time = 9223372036854775807L;
    MapMakerInternalMap.ReferenceEntry nextExpirable = MapMakerInternalMap.nullEntry();
  ...
  static final class StrongExpirableEvictableEntry extends MapMakerInternalMap.StrongEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    volatile long time = 9223372036854775807L;
    MapMakerInternalMap.ReferenceEntry nextExpirable = MapMakerInternalMap.nullEntry();
  ...
  static final class StrongEvictableEntry extends MapMakerInternalMap.StrongEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    MapMakerInternalMap.ReferenceEntry nextEvictable = MapMakerInternalMap.nullEntry();
    MapMakerInternalMap.ReferenceEntry previousEvictable = MapMakerInternalMap.nullEntry();
  ...
  static final class StrongExpirableEntry extends MapMakerInternalMap.StrongEntry
    implements MapMakerInternalMap.ReferenceEntry
  {
    volatile long time = 9223372036854775807L;
    MapMakerInternalMap.ReferenceEntry nextExpirable = MapMakerInternalMap.nullEntry();
  ...
  {
    STRONG, STRONG_EXPIRABLE, STRONG_EVICTABLE, STRONG_EXPIRABLE_EVICTABLE, SOFT, SOFT_EXPIRABLE, SOFT_EVICTABLE, SOFT_EXPIRABLE_EVICTABLE, WEAK, WEAK_EXPIRABLE, WEAK_EVICTABLE, WEAK_EXPIRABLE_EVICTABLE;

    static final int EXPIRABLE_MASK = 1;
    static final int EVICTABLE_MASK = 2;
    static final EntryFactory[][] factories = { { STRONG, STRONG_EXPIRABLE, STRONG_EVICTABLE, STRONG_EXPIRABLE_EVICTABLE }, { SOFT, SOFT_EXPIRABLE, SOFT_EVICTABLE, SOFT_EXPIRABLE_EVICTABLE }, { WEAK, WEAK_EXPIRABLE, WEAK_EVICTABLE, WEAK_EXPIRABLE_EVICTABLE } };
