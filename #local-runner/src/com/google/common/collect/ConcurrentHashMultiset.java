  ...
  implements Serializable
{
  ...
  private AtomicInteger safeGet(Object paramObject)
  {
    try
    {
      return (AtomicInteger)this.countMap.get(paramObject);
    }
  ...
  Set createElementSet()
  {
    ...
    return new ForwardingSet()
    {
      ...
      public boolean remove(Object paramAnonymousObject)
      {
        try
        {
          return localSet.remove(paramAnonymousObject);
        }
        catch (NullPointerException localNullPointerException)
        {
          return false;
  ...
  private class EntrySet extends AbstractMultiset.EntrySet
  {
    ...
    public boolean remove(Object paramObject)
    {
      if ((paramObject instanceof Multiset.Entry))
      {
        ...
        if (i != 0)
        {
          ConcurrentHashMultiset localConcurrentHashMultiset = multiset();
          return localConcurrentHashMultiset.setCount(localObject, i, 0);
        }
      }
      return false;
    }
