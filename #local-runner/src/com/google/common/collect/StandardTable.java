  ...
  implements Table, Serializable
{
  ...
  private class Values extends StandardTable.TableCollection
  {
    private Values()
    {
      super(null);
  ...
  class RowKeySet extends StandardTable.TableSet
  {
    RowKeySet()
    {
      super(null);
  ...
  class Row extends AbstractMap
  {
    ...
    private class RowEntrySet extends Maps.EntrySet
    {
      private RowEntrySet()
      {
      }
  ...
  private class CellSet extends StandardTable.TableSet
  {
    private CellSet()
    {
      super(null);
