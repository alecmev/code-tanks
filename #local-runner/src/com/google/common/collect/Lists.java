...
public final class Lists
{
  ...
  private static class RandomAccessListWrapper extends Lists.AbstractListWrapper
  ...
  private static class RandomAccessReverseList extends Lists.ReverseList
    implements RandomAccess
  {
  ...
  private static class RandomAccessPartition extends Lists.Partition
    implements RandomAccess
  {
    ...
    implements Serializable
  {
    ...
    public ListIterator listIterator(int paramInt)
    {
      final ListIterator localListIterator = this.fromList.listIterator(paramInt);
      return new ListIterator()
      {
        public void add(Object paramAnonymousObject)
        {
        ...
        public Object next()
        {
          return Lists.TransformingSequentialList.this.function.apply(localListIterator.next());
        }
        ...
        public Object previous()
        {
          return Lists.TransformingSequentialList.this.function.apply(localListIterator.previous());
        }
