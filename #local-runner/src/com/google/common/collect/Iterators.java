...
public final class Iterators
{
  ...
  static UnmodifiableListIterator unmodifiableListIterator(ListIterator paramListIterator)
  {
    Preconditions.checkNotNull(paramListIterator);
  ...
  public static Iterator cycle(Object[] paramArrayOfObject)
  {
    return cycle(Lists.newArrayList(paramArrayOfObject));
  }
  ...
  public static Iterator concat(Iterator[] paramArrayOfIterator)
  {
  ...
  public static UnmodifiableIterator forArray(final Object[] paramArrayOfObject)
  {
    Preconditions.checkNotNull(paramArrayOfObject);
    return new AbstractIndexedListIterator(paramArrayOfObject.length)
    {
      protected Object get(int paramAnonymousInt)
      {
        return paramArrayOfObject[paramAnonymousInt];
      }
    };
  }

  static UnmodifiableIterator forArray(Object[] paramArrayOfObject, int paramInt1, int paramInt2)
  {
    return forArray(paramArrayOfObject, paramInt1, paramInt2, 0);
  }
