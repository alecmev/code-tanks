...
public final class Iterables
{
  ...
  public static boolean contains(Iterable paramIterable, Object paramObject)
  {
    if ((paramIterable instanceof Collection))
    {
      ...
      try
      {
        return localCollection.contains(paramObject);
      }
  ...
  public static Iterable cycle(Object[] paramArrayOfObject)
  {
  ...
  public static Iterable concat(Iterable[] paramArrayOfIterable)
  {
  ...
  @Deprecated
  public static Iterable reverse(List paramList)
  {
  ...
  static boolean remove(Iterable paramIterable, Object paramObject)
  {
    Iterator localIterator = paramIterable.iterator();
