...
public final class Ints
{
  ...
  public static int indexOf(int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    if (paramArrayOfInt2.length == 0)
      return 0;
    label64: for (int i = 0; i < paramArrayOfInt1.length - paramArrayOfInt2.length + 1; i++)
    {
  ...
  {
    int i = 0;
    for (Object localObject2 : paramArrayOfInt)
  ...
  public static List asList(int[] paramArrayOfInt)
  {
    if (paramArrayOfInt.length == 0)
