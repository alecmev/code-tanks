...
public final class Bytes
{
  ...
  public static int indexOf(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    if (paramArrayOfByte2.length == 0)
      return 0;
    label64: for (int i = 0; i < paramArrayOfByte1.length - paramArrayOfByte2.length + 1; i++)
    {
  ...
  {
    int i = 0;
    for (Object localObject2 : paramArrayOfByte)
  ...
  public static List asList(byte[] paramArrayOfByte)
  {
