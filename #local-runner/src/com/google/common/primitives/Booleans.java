...
public final class Booleans
{
  ...
  public static int indexOf(boolean[] paramArrayOfBoolean1, boolean[] paramArrayOfBoolean2)
  {
    ...
    if (paramArrayOfBoolean2.length == 0)
      return 0;
    label64: for (int i = 0; i < paramArrayOfBoolean1.length - paramArrayOfBoolean2.length + 1; i++)
    {
  ...
  {
    int i = 0;
    for (Object localObject2 : paramArrayOfBoolean)
      i += localObject2.length;
    ??? = new boolean[i];
    ??? = 0;
    for (boolean[] arrayOfBoolean1 : paramArrayOfBoolean)
    {
  ...
  public static List asList(boolean[] paramArrayOfBoolean)
  {
    if (paramArrayOfBoolean.length == 0)
