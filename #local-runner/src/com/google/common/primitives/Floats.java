...
public final class Floats
{
  ...
  {
    return ((1.0F / -1.0F) < paramFloat ? 1 : 0) & (paramFloat < (1.0F / 1.0F) ? 1 : 0);
  }
  ...
  public static int indexOf(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    if (paramArrayOfFloat2.length == 0)
      return 0;
    label65: for (int i = 0; i < paramArrayOfFloat1.length - paramArrayOfFloat2.length + 1; i++)
    {
  ...
  {
    Preconditions.checkArgument(paramArrayOfFloat.length > 0);
  ...
  {
    int i = 0;
    for (Object localObject2 : paramArrayOfFloat)
      i += localObject2.length;
    ??? = new float[i];
    ??? = 0;
    for (float[] arrayOfFloat1 : paramArrayOfFloat)
    {
  ...
  public static String join(String paramString, float[] paramArrayOfFloat)
  {
    ...
    if (paramArrayOfFloat.length == 0)
      return "";
    StringBuilder localStringBuilder = new StringBuilder(paramArrayOfFloat.length * 12);
  ...
  public static List asList(float[] paramArrayOfFloat)
  {
    if (paramArrayOfFloat.length == 0)
