...
public final class Shorts
{
  ...
  public static int indexOf(short[] paramArrayOfShort1, short[] paramArrayOfShort2)
  {
    ...
    if (paramArrayOfShort2.length == 0)
      return 0;
    label64: for (int i = 0; i < paramArrayOfShort1.length - paramArrayOfShort2.length + 1; i++)
    {
  ...
  {
    Preconditions.checkArgument(paramArrayOfShort.length > 0);
  ...
  {
    int i = 0;
    for (Object localObject2 : paramArrayOfShort)
      i += localObject2.length;
    ??? = new short[i];
    ??? = 0;
    for (short[] arrayOfShort1 : paramArrayOfShort)
    {
  ...
  public static List asList(short[] paramArrayOfShort)
  {
    if (paramArrayOfShort.length == 0)
