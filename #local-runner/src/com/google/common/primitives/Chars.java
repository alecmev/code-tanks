...
public final class Chars
{
  ...
  public static int indexOf(char[] paramArrayOfChar1, char[] paramArrayOfChar2)
  {
    ...
    if (paramArrayOfChar2.length == 0)
      return 0;
    label64: for (int i = 0; i < paramArrayOfChar1.length - paramArrayOfChar2.length + 1; i++)
    {
  ...
  {
    Preconditions.checkArgument(paramArrayOfChar.length > 0);
  ...
  {
    int i = 0;
    for (Object localObject2 : paramArrayOfChar)
      i += localObject2.length;
    ??? = new char[i];
    ??? = 0;
    for (char[] arrayOfChar1 : paramArrayOfChar)
    {
  ...
  public static List asList(char[] paramArrayOfChar)
  {
