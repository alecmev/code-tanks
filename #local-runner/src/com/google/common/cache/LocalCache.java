  ...
  implements ConcurrentMap
{
  ...
  ValueReference newValueReference(ReferenceEntry paramReferenceEntry, Object paramObject, int paramInt)
  {
    ...
    return this.valueStrength.referenceValue(segmentFor(i), paramReferenceEntry, paramObject, paramInt);
  }
  ...
  ReferenceEntry getLiveEntry(Object paramObject)
  {
    if (paramObject == null)
      return null;
    int i = hash(paramObject);
    return segmentFor(i).getLiveEntry(paramObject, i, this.ticker.read());
  }

  void refresh(Object paramObject)
  {
    int i = hash(Preconditions.checkNotNull(paramObject));
    segmentFor(i).refresh(paramObject, i, this.defaultLoader);
  }
  ...
  static class LocalLoadingCache extends LocalCache.LocalManualCache
    ...
    implements Cache, Serializable
  {
      ...
      throws ExecutionException
    {
      ...
      return this.localCache.get(paramObject, new CacheLoader()
      {
  ...
  static final class LoadingSerializationProxy extends LocalCache.ManualSerializationProxy
  ...
  final class Values extends AbstractCollection
  {
    ...
    public boolean contains(Object paramObject)
    {
      return LocalCache.this.containsValue(paramObject);
    }
  ...
  final class KeySet extends AbstractSet
  {
    ...
    public boolean contains(Object paramObject)
    {
      return LocalCache.this.containsKey(paramObject);
    }

    public boolean remove(Object paramObject)
    {
      return LocalCache.this.remove(paramObject) != null;
    }
    ...
    implements LocalCache.ValueReference
  {
    ...
    public ListenableFuture loadFuture(Object paramObject, CacheLoader paramCacheLoader)
    {
      ...
      try
      {
        ...
        return localObject2 != null ? localObject2 : Futures.immediateFuture(null);
      }
      catch (Throwable localThrowable)
      {
  ...
  static class Segment extends ReentrantLock
  {
    ...
    Object lockedGetOrLoad(Object paramObject, int paramInt, CacheLoader paramCacheLoader)
      throws ExecutionException
    {
      LocalCache.ValueReference localValueReference = null;
    ...
    {
      if ((this.map.refreshes()) && (paramLong - paramReferenceEntry.getWriteTime() > this.map.refreshNanos))
      {
        Object localObject = refresh(paramObject1, paramInt, paramCacheLoader);
        if (localObject != null)
          return localObject;
      }
      return paramObject2;
    ...
    LocalCache.LoadingValueReference insertLoadingValueReference(Object paramObject, int paramInt)
    {
      Object localObject1 = null;
      lock();
      try
