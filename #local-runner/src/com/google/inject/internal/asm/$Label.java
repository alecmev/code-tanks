  ...
  void b(Label paramLabel, long paramLong, int paramInt)
  {
    if (paramLabel != null)
    {
      if ((this.a & 0x400) != 0)
        return;
      this.a |= 1024;
      if (((this.a & 0x100) != 0) && (!a(paramLabel)))
      {
        localEdge = new $Edge();
        localEdge.a = this.f;
    ...
    for ($Edge localEdge = this.j; localEdge != null; localEdge = localEdge.c)
      if (((this.a & 0x80) == 0) || (localEdge != this.j.c))
        localEdge.b.b(paramLabel, paramLong, paramInt);
  }
 ...
 * Qualified Name:     com.google.inject.internal.asm..Label
