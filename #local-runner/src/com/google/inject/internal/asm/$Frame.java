...
final class $Frame
{
  ...
  private int a($ClassWriter paramClassWriter, int paramInt)
  {
    ...
    {
      j = 0x1700000 | paramClassWriter.c(paramClassWriter.F);
    }
    else if ((paramInt & 0xFFF00000) == 25165824)
    {
      String str = paramClassWriter.E[(paramInt & 0xFFFFF)].g;
    ...
    for (int k = 0; k < this.h; k++)
    {
      ...
      int i1 = m & 0xF000000;
      if (i1 == 33554432)
        m = n + this.c[(m & 0xFFFFFF)];
      else if (i1 == 50331648)
        m = n + this.d[(this.d.length - (m & 0xFFFFFF))];
      if (paramInt == m)
        return j;
    }
    return paramInt;
  ...
  void a($ClassWriter paramClassWriter, int paramInt1, .Type[] paramArrayOfType, int paramInt2)
  {
    ...
    if ((paramInt1 & 0x8) == 0)
      if ((paramInt1 & 0x40000) == 0)
        this.c[(j++)] = (0x1700000 | paramClassWriter.c(paramClassWriter.F));
      else
        this.c[(j++)] = 16777222;
    ...
    for (int m = 0; m < j; m++)
    {
      if ((this.e != null) && (m < this.e.length))
      {
        ...
        else
        {
          ...
          i3 = n & 0xF000000;
          if (i3 == 33554432)
            i1 = i2 + this.c[(n & 0xFFFFFF)];
          else if (i3 == 50331648)
            i1 = i2 + this.d[(k - (n & 0xFFFFFF))];
          else
            i1 = n;
        }
      }
 ...
 * Qualified Name:     com.google.inject.internal.asm..Frame
