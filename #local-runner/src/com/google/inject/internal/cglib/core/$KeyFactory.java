...
public abstract class $KeyFactory
{
  ...
  public static class Generator extends $AbstractClassGenerator
  {
    ...
    public void generateClass($ClassVisitor paramClassVisitor)
    {
      ...
      j = this.constant != 0 ? this.constant : .KeyFactory.PRIMES[(java.lang.Math.abs(i) % .KeyFactory.PRIMES.length)];
      int k = this.multiplier != 0 ? this.multiplier : .KeyFactory.PRIMES[(java.lang.Math.abs(i * 13) % .KeyFactory.PRIMES.length)];
 ...
 * Qualified Name:     com.google.inject.internal.cglib.core..KeyFactory
