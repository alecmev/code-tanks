...
public class $FinalizableReferenceQueue
{
  ...
  private static final Method startFinalizer = getStartFinalizer(localClass);
  ...
  {
    for (FinalizerLoader localFinalizerLoader : paramArrayOfFinalizerLoader)
    {
  ...
  static Method getStartFinalizer(Class paramClass)
  {
    try
    {
      return paramClass.getMethod("startFinalizer", new Class[] { Class.class, Object.class });
    }
    ...
    implements .FinalizableReferenceQueue.FinalizerLoader
  {
    ...
    public Class loadFinalizer()
    {
      try
      {
        ...
        return localURLClassLoader.loadClass("com.google.inject.internal.util.$Finalizer");
      }
    ...
    URL getBaseUrl()
      throws IOException
    {
      String str1 = "com.google.inject.internal.util.$Finalizer".replace('.', '/') + ".class";
    ...
    implements .FinalizableReferenceQueue.FinalizerLoader
  {
    public Class loadFinalizer()
    {
      ...
      if (localClassLoader != null)
        try
        {
          return localClassLoader.loadClass("com.google.inject.internal.util.$Finalizer");
        }
        catch (ClassNotFoundException localClassNotFoundException)
        {
          return null;
 ...
 * Qualified Name:     com.google.inject.internal.util..FinalizableReferenceQueue
